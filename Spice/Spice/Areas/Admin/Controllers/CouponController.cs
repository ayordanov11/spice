...
namespace Spice.Areas.Admin.Controllers
{
    ...
    public class CouponController : Controller
    {
        ...
        {
            //return all of the coupons and pass it to the view
            return View(await _db.Coupon.ToListAsync());
        }

        //we don't need to pass anything to create so just IActionResult
        public IActionResult Create()
        {
            //just return to the View
            return View();
        }

        //POST - CREATE - always HttpoPost and Validate
        [HttpPost]
